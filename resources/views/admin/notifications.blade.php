...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <div class="row m-20">
      <div class="col-sm-4">
        <input type="text" id="search" placeholder="Search Notification Heading.." value="{{ $search }}" class="form-control">
      </div>
              ...
              <tbody>
                @if(count($notifications) > 0)
                  ...
                  <tr>
                    ...
                    <td>{{$value->type}}</td>
                    <td>
                      @if(isset($courses[$value->course_id]))
                    ...
                    <td align="center">
                      <form action="{{url('/admin/notifications/delete/'.$value->id)}}" method="POST" role="form" id="delform{{$value->id}}">
                        {!! csrf_field() !!}
                        <button type="button" class="btn btn-sm btn-danger" title="Delete Notification" data-toggle="modal" data-target="#modal-delete" onclick="mkeDelModal('{{$value->id}}', 'Notifications');">
          ...
          <div class="modal-body">
            ...
            <div class="card-body">
              <div class="form-group row">
                <label for="heading" class="col-sm-3 col-form-label text-right">Type<span class="text-danger">*</span> :</label>
                <div class="col-sm-9">
                  <select class="form-control" id="type" name="type" onchange="check(this.value)">
                    <option value="Global">Global</option>
                    <option value="Course">Course</option>
                  </select>
                  <span class="invalid-feedback">Please enter Notification Type.</span>
                </div>
              </div>

              <div class="form-group row hide" id="hidecourse">
                <label for="sub_heading" class="col-sm-3 col-form-label text-right">Courses:</label>
                <div class="col-sm-9">
              ...
              <div class="form-group row">
                <label for="heading" class="col-sm-3 col-form-label text-right">Heading<span class="text-danger">*</span> :</label>
                <div class="col-sm-9">
              ...
              <div class="form-group row">
                <label for="sub_heading" class="col-sm-3 col-form-label text-right">Sub-Heading<span class="text-danger">*</span> :</label>
                <div class="col-sm-9">
...
<script>
  function check(type) {
    if(type == 'Global') {
      $('#hidecourse').addClass('hide');
    } else {
      $('#hidecourse').removeClass('hide');
    }
  }

  $('#searchBtn').click(function() {
    var url = '{{url('/admin/notifications')}}?q=' + $('#search').val();
