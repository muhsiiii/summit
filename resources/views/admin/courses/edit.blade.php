  ...
  <div class="row m-10">
    <div class="col-12">
      <div class="card card-primary">
        ...
        <form method="POST" action="{{url('/admin/courses/'.$course->id)}}" accept-charset="UTF-8" role="form" id="addForm" enctype="multipart/form-data">
          @csrf
          <div class="card-body">
            <div class="row">
              <div class="col-md-4">
                <div class="form-group" >
                  ...
                  <select class="form-control" style="width: 100%;" name="cat_id" id="cat_id">
                    <option value="{{$course->cat_id}}" selected>{{$catname}}</option>
                  </select>
              ...
              <div class="col-md-8">
                <div class="form-group">
                  ...
                  <input class="form-control" placeholder="Enter Course Name" name="name" type="text" value="{{$course->name}}" id="name" >
              ...
              <div class="col-md-3">
                <div class="form-group">
                  ...
                  <select id="duration" class="form-control" name="duration" >
                    ...
                    @for($i = 1; $i <= 36; $i++)
                      <option value="{{$i}}" @if($course->duration == $i) selected @endif >{{$i}} Month</option>
                    @endfor
                  </select>
              ...
              <div class="col-md-3">
                <div class="form-group">
                  ...
                  <input class="form-control" placeholder="Enter Course Amount" min="0" id="amount" name="amount" type="number" value="{{$course->amount}}">
              ...
              <div class="col-md-3">
                <div class="form-group">
                  ...
                  <input class="form-control" placeholder="Enter Course Offer price" min="0" id="offer_amount" name="offer_amount" type="number" value="{{$course->offer_amount}}">
                  <div class="invalid-feedback">Course Amount Required.</div>
                </div>
              </div>
              ...
              <div class="col-md-3">
                <div class="form-group">
                  ...
                  <select class="form-control select2bs4" style="width: 100%;" name="status" id="status">
                    ...
                    <option value="Suspended" @if($course->status == 'Suspended') selected @endif >Suspended</option>
                    <option value="Deleted" @if($course->status == 'Deleted') selected @endif >Deleted</option>
                  </select>
              ...
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <textarea class="form-control" id="keyword" name="keyword" rows="3" placeholder="Enter Page Keywords">{{$course->keyword}}</textarea>
              ...
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <textarea class="form-control" id="content" name="content" rows="3" placeholder="Enter Page Content">{{$course->content}}</textarea>
              ...
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <textarea class="form-control" id="overview" name="overview" rows="4" placeholder="Enter Course Overview">{{$course->overview}}</textarea>
              ...
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <textarea class="form-control" id="desc" name="desc" rows="4" placeholder="Enter Course Description">{{$course->desc}}</textarea>
              ...
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <textarea class="form-control" id="highlight" name="highlight" rows="4" placeholder="Enter Course Highlight">{{$course->highlight}}</textarea>
              ...
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <textarea class="form-control" id="notes" name="notes" rows="4" placeholder="Enter Course Notes">{{$course->notes}}</textarea>
            ...
            <div class="row">
              <div class="col-md-6">
                  ...
                  <div class="col-md-10 col-8">
                    <div class="input-group">
                      <div class="custom-file">
                        ...
                        <input id="imageOld" name="imageOld" type="hidden" value="{{$course->image}}">
                ...
                <div class="row">
                  <div class="col-md-6">
                    <img id="showImage"  class="img-thumbnail <?php if($course->image == '') echo 'hide'; ?>" src="{{url($course->image)}}" width="100%" height="auto" style="min-width:140px; max-width:300px;">
                  </div>
                </div>
