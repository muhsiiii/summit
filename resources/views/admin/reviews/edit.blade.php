  ...
  <div class="row m-10">
    <div class="col-12">
      <div class="card card-primary">
        ...
        <form method="POST" action="{{url('/admin/reviews/'.$reviews->id)}}" accept-charset="UTF-8" role="form" id="addForm" enctype="multipart/form-data">
          @csrf
          <div class="card-body">
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input class="form-control" placeholder="Enter Reviewer Name" name="name" type="text" id="name" value="{{$reviews->name}}">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input class="form-control" placeholder="Enter Review Date" name="date" type="date" id="date" value="{{$reviews->date}}">
              ...
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <input class="form-control" placeholder="Enter Review Heading" name="heading" type="text" id="heading" value="{{$reviews->heading}}">
              ...
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <textarea class="form-control" placeholder="Enter Review Message" name="message" rows="3" id="message">{{$reviews->message}}</textarea>
            ...
            <div class="row">
              <div class="col-md-6">
                  ...
                  <div class="col-md-10 col-8">
                    <div class="input-group">
                      <div class="custom-file">
                        ...
                        <input id="imageOld" name="imageOld" type="hidden" value="{{$reviews->image}}">
                        <label class="custom-file-label" for="image">Choose file</label>
                      </div>
                    </div>
                    <span class="error hide text-danger" id="helpImage">Review Image Required.</span>
                  </div>
                ...
                <div class="row">
                  <div class="col-md-6">
                    <img id="showImage"  class="img-thumbnail <?php if($reviews->image == '') echo 'hide'; ?>" src="{{url($reviews->image)}}" width="100%" height="auto" style="min-width:140px; max-width:300px;">
                  </div>
                </div>
