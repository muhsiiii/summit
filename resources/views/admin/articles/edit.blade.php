    ...
    <div class="col-12">
      <div class="card card-primary">
        <div class="card-header">
          <h3 class="card-title">Update Articles</h3>
        </div>
        <form method="POST" action="{{url('/admin/articles/'.$articles->id)}}" accept-charset="UTF-8" role="form" id="addForm" enctype="multipart/form-data">
          @csrf
          <div class="card-body">
            <div class="row">
              ...
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <textarea class="form-control" id="heading" name="heading" rows="2" placeholder="Enter Article Heading">{{$articles->heading}}</textarea>
              ...
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <textarea class="form-control" id="keyword" name="keyword" rows="3" placeholder="Enter Page Keywords">{{$articles->keyword}}</textarea>
              ...
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <textarea class="form-control" id="content" name="content" rows="3" placeholder="Enter Page Content">{{$articles->content}}</textarea>
              ...
              <div class="col-md-12">
                <div class="form-group ">
                  ...
                  <textarea class="form-control" id="article_content" name="article_content" rows="4" placeholder="Enter Article Content">{{$articles->article_content}}</textarea>
              ...
              <div class="col-md-6">
                ...
                <div class="form-group row">
                  <div class="col-md-10 col-8">
                    <div class="input-group">
                      <div class="custom-file">
                        ...
                        <input id="imageOld" name="imageOld" type="hidden" value="{{$articles->image}}">
                  ...
                  <div class="col-md-2 col-4">
                    <button type="button" class="btn btn-secondary btn-tooltip float-left" data-toggle="tooltip" data-placement="top" title="Image with 1:2 Aspet Raio Required. ie Image with Resolution 600px x 300px, 1000px x 500px ..etc.">
                ...
                <div class="row">
                  <div class="col-md-6">
                    <img id="showImage"  class="img-thumbnail <?php if($articles->image == '') echo 'hide'; ?>" src="{{url($articles->image)}}" width="100%" height="auto" style="min-width:140px; max-width:300px;">
                  </div>
                </div>
