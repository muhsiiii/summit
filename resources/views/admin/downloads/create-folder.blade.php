    ...
    <div class="col-12">
      <div class="card card-primary">
        <div class="card-header">
          <h3 class="card-title">Create New Sub-Folder</h3>
        </div>

        <form method="POST" action="{{url('/admin/downloads/create/'.$id)}}" accept-charset="UTF-8" role="form" id="addForm" enctype="multipart/form-data">
          @csrf
          <div class="card-body">
            <div class="row">
          ...
          <div class="card-footer">
            <a class="btn btn-default" href="{{url('/admin/downloads/'.$id)}}">Back</a>&emsp;
