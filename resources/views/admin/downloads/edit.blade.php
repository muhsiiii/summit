  ...
  <div class="row m-10">
    <div class="col-12">
      <div class="card card-primary">
        ...
        <form method="POST" action="{{url('/admin/downloads/update/'.$downloads->id)}}" accept-charset="UTF-8" role="form" id="addForm" enctype="multipart/form-data">
          @csrf
          <div class="card-body">
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="name" name="name" placeholder="Enter Folder Name" value="{{$downloads->name}}">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <select class="form-control" id="type" name="type" disabled>
                    <option value="Folders" @if($downloads->type == 'Folders') selected @endif >Folders</option>
                    <option value="Files" @if($downloads->type == 'Files') selected @endif >Files</option>
                  </select>
              ...
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <textarea class="form-control" id="desc" name="desc" rows="2" placeholder="Enter Folder Small description">{{$downloads->desc}}</textarea>
              ...
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <textarea class="form-control" id="keyword" name="keyword" rows="3" placeholder="Enter Page Keywords">{{$downloads->keyword}}</textarea>
              ...
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <textarea class="form-control" id="content" name="content" rows="3" placeholder="Enter Page Content">{{$downloads->content}}</textarea>
